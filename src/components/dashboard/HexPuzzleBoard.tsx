...
export const HexPuzzleBoard: React.FC<HexPuzzleBoardProps> = ({ missions }) => {
  ...
  return (
    <div
      className="relative w-full mx-auto aspect-[1.15/1] max-w-md bg-muted/10 border-2 border-dashed border-border/30 transition-colors duration-500 overflow-hidden"
      style={{
